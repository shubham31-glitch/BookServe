  ...
  function validateAndLogin() {
    ...
    if (userTypeRef.current.value == "Client") {
      axios
        ...
        .then((data) => {
          toast.success(`Login Successful, Welcome ${data.data.name}`);
      ...
      <div className="sub-login-section">
        <div className="left-login">
          ...
          <select ref={userTypeRef}>
            ...
            <option
              value={"Client"}
              selected={navigateState.state?.userType == "client"}
            >
              Client
            </option>
            <option
              value={"Serviceperson"}
              selected={navigateState.state?.userType == "serviceperson"}
            >
              Service Provider
            </option>
          </select>
          <p>
            New here? <br />
            Sign up today as a <Link to="/customerSignUp">
              Customer
            </Link> or <Link to="/serviceProviderSignUp">Service Provider</Link>
            !
          </p>
          <button className="confirm-btn" onClick={validateAndLogin}>
            Login
          </button>
        </div>
