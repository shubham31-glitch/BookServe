        ...
        <div className="about-sec">
            ...
            <div className="work">
                ...
                <div className="who-content">
                    <h1>WHO WE ARE</h1>
                    <h3>Welcome to BookServe – your go-to destination for hassle-free online booking!</h3>
                    <p> We are a team of dedicated enthusiasts and technology experts who have come together to make your daily event planning experience as easy as possible.
                        ...
                        At BookServe, we understand that planning to schedule an appointment for service  can sometimes be overwhelming. </p>
