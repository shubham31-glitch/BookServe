                ...
                <div className="service-wrap">
                    ...
                    <div className="service-txt">
                        ...
                        <p>Offering a simple-to-use online platform chock-full of Service Providers with plumbing experience,
                            BookServe is your go-to for virtually any plumbing need you might have.</p>
                        <p>
            ...
            <section className="how-it-works">
                ...
                <div className="works-container">
                    ...
                    <div className="get-it-done">
                        ...
                        <div className="how-works-content">
                            <h2>Get It Done!</h2>
                            <p>Your service provider arrives and gets the job done. Pay securely and leave a review, all through BookServe.</p>
                        </div>
