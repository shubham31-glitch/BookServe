    ...
    <div className="dashboard">
      ...
      <section className="home-page">
        <div className="home-wrap">
          <h1>BookServe: Connecting You with Trusted Service Professionals</h1>
          <h3>
            At BookServe, we believe in simplifying your life by connecting you
      ...
      <section id="service-cards" className="service-cardss">
        ...
        <div className="service-containers">
          ...
          <div className="services-card">
            <img src="images/plumbing.jpeg" width="480" height="310" />
      ...
      <section className="book-info">
        <div className="info-content">
          ...
          <h3>
            When life gets hectic, you don't have to handle it all on your own.
            Reclaim your time for the things you enjoy, without overspending.
          </h3>
          <p>
            Select your Service Provider based on reviews, skills, and pricing
          </p>
